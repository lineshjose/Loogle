...
<?php
	...
	if ( have_comments() ) : ?>
<legend>
<?php comments_number(__('0 Comments','Clean'),  __('1 Comment','Clean'), '% '.__('Comments','Clean').'');?>
</legend>
...
<div  id="respond">
  ...
  <p class="alignright">
    ...
    &raquo;</a></p>
  <?php endif; ?>
  <span id="cancel-comment-reply" class="alignright">
  <?php cancel_comment_reply_link(__('Click here to cancel reply.','Clean').('') ); ?>
  </span>
  <h3 >
    <?php _e('Leave a Response','Clean'); ?>
  </h3>
  ...
  <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
    <table cellpadding="0" cellspacing="0" >
      <tr>
        <td><?php if (get_option("comment_moderation") == "1") { ?>
          <p>
          ...
          <table cellpadding="0" cellspacing="0" >
            <tr>
              <td align="left"><span>
                ...
                <br />
                <input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1"  class="textbox" placeholder="Type your name here"/></td>
              <td><span>
                <?php if ($req) echo "**"; ?>
                </span>
                <label for="email"> Mail</label>
                <br />
                <input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" class="textbox" placeholder="Type your email adderess here"/></td>
              <td><label for="url">Website</label>
                <br />
                <input type="text" name="url" id="url" value="<?php echo $comment_author_url; ?>" size="22" tabindex="3" class="textbox" placeholder="Type your web adderess here" /></td>
            </tr>
          </table>
          <?php endif; ?>
          <?php comment_id_fields(); ?></td>
      </tr>
        ...
        <td ><span>
          ...
          <span>*</span> Required , <span>**</span> will not be published. </td>
      </tr>
    </table>
